...
TRANSFORM_PAIR (cicp_to_oklab,   cicp_to_srgb,  srgb_to_oklab)
TRANSFORM_PAIR (cicp_from_oklab, oklab_to_srgb, cicp_from_srgb)
TRANSFORM_PAIR (cicp_to_oklch,   cicp_to_srgb,  srgb_to_oklch)
TRANSFORM_PAIR (cicp_from_oklch, oklch_to_srgb, cicp_from_srgb)
